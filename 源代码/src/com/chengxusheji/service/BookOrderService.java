...
public class BookOrderService {
    ...
    /*按照查询条件分页查询场地预订记录*/
    public ArrayList<BookOrder> queryBookOrder(Space spaceObj,SpaceType spaceTypeObj,UserInfo userObj,String startTime,String orderState,String orderTime,int currentPage) throws Exception { 
     	String where = "where 1=1";
    	if(null != spaceObj &&  spaceObj.getSpaceNo() != null  && !spaceObj.getSpaceNo().equals(""))  where += " and t_bookOrder.spaceObj='" + spaceObj.getSpaceNo() + "'";
    	if(null != spaceTypeObj && spaceTypeObj.getSpaceTypeId()!= null && spaceTypeObj.getSpaceTypeId()!= 0)  where += " and t_bookOrder.spaceTypeObj=" + spaceTypeObj.getSpaceTypeId();
    	if(null != userObj &&  userObj.getUser_name() != null  && !userObj.getUser_name().equals(""))  where += " and t_bookOrder.userObj='" + userObj.getUser_name() + "'";
    	if(!startTime.equals("")) where = where + " and t_bookOrder.startTime like '%" + startTime + "%'";
    ...
    /*按照查询条件查询所有记录*/
    public ArrayList<BookOrder> queryBookOrder(Space spaceObj,SpaceType spaceTypeObj,UserInfo userObj,String startTime,String orderState,String orderTime) throws Exception  { 
     	String where = "where 1=1";
    	if(null != spaceObj &&  spaceObj.getSpaceNo() != null && !spaceObj.getSpaceNo().equals(""))  where += " and t_bookOrder.spaceObj='" + spaceObj.getSpaceNo() + "'";
    	if(null != spaceTypeObj && spaceTypeObj.getSpaceTypeId()!= null && spaceTypeObj.getSpaceTypeId()!= 0)  where += " and t_bookOrder.spaceTypeObj=" + spaceTypeObj.getSpaceTypeId();
    	if(null != userObj &&  userObj.getUser_name() != null && !userObj.getUser_name().equals(""))  where += " and t_bookOrder.userObj='" + userObj.getUser_name() + "'";
    ...
    /*当前查询条件下计算总的页数和记录数*/
    public void queryTotalPageAndRecordNumber(Space spaceObj,SpaceType spaceTypeObj,UserInfo userObj,String startTime,String orderState,String orderTime) throws Exception {
     	String where = "where 1=1";
    	if(null != spaceObj &&  spaceObj.getSpaceNo() != null && !spaceObj.getSpaceNo().equals(""))  where += " and t_bookOrder.spaceObj='" + spaceObj.getSpaceNo() + "'";
    	if(null != spaceTypeObj && spaceTypeObj.getSpaceTypeId()!= null && spaceTypeObj.getSpaceTypeId()!= 0)  where += " and t_bookOrder.spaceTypeObj=" + spaceTypeObj.getSpaceTypeId();
    	if(null != userObj &&  userObj.getUser_name() != null && !userObj.getUser_name().equals(""))  where += " and t_bookOrder.userObj='" + userObj.getUser_name() + "'";
