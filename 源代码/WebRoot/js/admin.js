		       ...
		       text: "场地信息管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "SpaceType/spaceType_add.jsp"
			    	   	},
			    		{
			    	   		text: "场地类型管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "SpaceType/spaceType_query_result.jsp"
			    	    },
			    	    {
			    		    text: "添加场地",
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Space/space_add.jsp"
			    	   	},
			    		{
			    	   		text: "场地管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Space/space_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "场地预订管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "BookOrder/bookOrder_add.jsp"
			    	   	},
			    		{
			    	   		text: "场地预订管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "BookOrder/bookOrder_query_result.jsp"
			    	    },
