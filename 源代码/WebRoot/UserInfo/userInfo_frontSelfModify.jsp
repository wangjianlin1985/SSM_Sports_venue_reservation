	...
	<ul class="breadcrumb">
		...
		<div class="row"> 
		  ...
		  <div class="form-group">
		  	 ...
		  	 <div class="col-md-6">
			    <img  class="img-responsive" id="userInfo_userPhotoImg" border="0px"style="width:300px;height:300px;"/><br/>
	    ...
	    <style>#userInfoEditForm .form-group {margin-bottom:15px;}  </style>
      </div>
   </div>
</div>
