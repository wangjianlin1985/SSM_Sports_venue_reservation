...
<nav class="navbar navbar-default navbar-fixed-top" style="background-color:#F5F5F5">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand"style="color:#3C736B;">体育场地</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                <li><a href="<%=basePath %>index.jsp"style="color:#3C736B;">首页</a></li>
               
                <!--<li><a href="<%=basePath %>SpaceType/frontlist">场地类型</a></li>-->
                <li><a href="<%=basePath %>Space/frontlist"style="color:#3C736B;">场地查询</a></li>
                <!--<li><a href="<%=basePath %>BookOrder/frontlist">场地预订</a></li>-->
             ...
             <ul class="nav navbar-nav navbar-right">
             	<%
				    ...
				    if(user_name==null){
	  			%> 
	  			<li><a href="<%=basePath %>UserInfo/userInfo_frontAdd.jsp"style="color:#3C736B;"><i class="fa fa-sign-in"></i>&nbsp;&nbsp;注册</a></li>
                <li><a href="#" onclick="login();"style="color:#3C736B;"><i class="fa fa-user"></i>&nbsp;&nbsp;登录</a></li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        <li><a href="<%=basePath %>BookOrder/userFrontlist"><span class="glyphicon glyphicon-screenshot"></span>&nbsp;&nbsp;我的场地预订</a></li>
                        <li><a href="<%=basePath %>Leaveword/leaveword_frontUserAdd.jsp"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;我要留言</a></li>
